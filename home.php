...
<div class="container mt-5 mb-5">   
  ...
  <div class="row g-4">     
    ...
    <div class="col-md-4">       
      <div class="card shadow-sm h-100">         
        <div class="card-body">           
          ...
          <p class="card-text text-muted">Download a sample CV guide in PDF format.</p>           

         
          <a href="assets/How to write a CV.pdf" download class="btn btn-outline-primary w-100">
    ...
    <div class="col-md-4">       
      <div class="card shadow-sm h-100">         
        <div class="card-body">           
          <h5 class="card-title">Interview Preparation Guide</h5>           
          <p class="card-text text-muted">Download a structured interview preparation manual.</p>           

          
          <a href="assets/Interview Preparation Guide.pdf" download class="btn btn-outline-primary w-100">
            <i class="fas fa-download"></i> Download PDF
          </a>
